...
SECRET_KEY = 'nvs#j&z_h4qks-3vsq(ci-4&n37c*_i6u-e^tev30^3yqe#\\=^f'
...
MARKDOWNIFY_WHITELIST_TAGS = ['a', 'blockquote', 'code', 'em', 'h1', 'h2', 'h3',
                              'h4', 'h5', 'h6', 'h7', 'li', 'ol', 'p', 'pre',
                              'strong', 'ul']
...
# Email settings
MAILING_LIST_FROM_EMAIL = 'alex@graywolf.name'
