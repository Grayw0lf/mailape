...
urlpatterns = [
    ...
    path('new/', views.CreateMailingListView.as_view(),
    ...
    path('<uuid:mailinglist_id>/subscribe/',
         views.SubscribeToMailingListView.as_view(), name='subscribe'),
    ...
    path('unsubscribe/<uuid:pk>/', views.UnsubscribeView.as_view(),
         name='unsubscribe'),
    path('<uuid:mailinglist_id>/message/new/', views.CreateMessageView.as_view(),
         name='create_message'),
